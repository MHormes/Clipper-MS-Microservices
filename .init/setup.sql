...
EXEC CreateDatabaseIfNotExists 'collection';

-- Create trading database
EXEC CreateDatabaseIfNotExists 'trading';

-- Create keycloak database
EXEC CreateDatabaseIfNotExists 'keycloak';
...
DECLARE DB_CURSOR CURSOR FOR
    SELECT name
    FROM sys.databases
    WHERE name IN ('collection', 'trading', 'keycloak');
