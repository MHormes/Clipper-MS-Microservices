...
export default () => {
    const url = 'http://localhost:8071/collection/api/collection/add/943914CB-F741-4DC2-AD30-5D1B9B2FEAF8/8ABD08F3-02AE-48AF-A552-FE19B552D867';
    ...
    //default payload to satisfy the .post function
    ...
    const result = http.post(url, payload, { headers });
